...
#   timestamp: 2025-06-28T15:06:55+00:00
...
class CertificateParameters(BaseModel):
    ...
    exsession: str = Field(..., description='Exam Session', examples=['MAR or OCT'])
    rollnumber: str = Field(..., description='Seat No', examples=['P183286'])
    totalmarks: str = Field(..., description='Total Marks', examples=['389'])
    year: str = Field(..., description='Year', examples=['2015'])
...
class CertificateParameters2(BaseModel):
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    exsession: str = Field(..., description='Exam Session', examples=['MAR or OCT'])
    rollnumber: str = Field(..., description='Seat No', examples=['C183286'])
    totalmarks: str = Field(..., description='Total Marks', examples=['517'])
    year: str = Field(..., description='Year', examples=['2015'])


class SpcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters2] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
    )
